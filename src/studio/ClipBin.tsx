...
export default function ClipBin({ usedClipIds, selectedClipId, hasCut, beats, onPickClip, onAddClip }: Props) {
  ...
  return (
    <aside className="st-col bin">
      <div className="st-colhead">Clips <span className="cnt st-num">{state.clips.length}</span></div>
