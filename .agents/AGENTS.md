...
1. **Strictly adhere to [DESIGN_PATTERNS.md](file:///Users/prime/Documents/Web/projects/simple-video-editor/DESIGN_PATTERNS.md)** — the Design Bible. **Never stray away from this established design system under any circumstances.**
...
1. **Never execute `git commit` unless explicitly prompted by the user.**
2. **Never stray away from established design patterns** documented in [DESIGN_PATTERNS.md](file:///Users/prime/Documents/Web/projects/simple-video-editor/DESIGN_PATTERNS.md).
